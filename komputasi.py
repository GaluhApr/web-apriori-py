...
def MBA(df, pembeli, produk):
    ...
    if st.button("Mulai Perhitungan Asosiasi"):
        ...
        frequent_itemsets = apriori(df2, min_support=0.009, use_colnames=True)   #nilai support yang digunakan
        try:
            rules = association_rules(frequent_itemsets, metric='confidence', min_threshold=0.04)  #nilai confidence yang diinginkan
