...
def MBA(df, pembeli, produk):
    ...
    support = st.number_input("Masukkan nilai support:", min_value=0.001, max_value=1.0, value=0.005, step=0.001, format="%.3f")
    min_confidence = st.number_input("Masukkan minimum confidence:", min_value=0.01, max_value=1.0, value=0.01)
