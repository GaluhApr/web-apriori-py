...
def MBA(df, pembeli, produk):
    ...
    min_support = st.number_input("Masukkan nilai support:", min_value=0.001, max_value=1.0,)
    min_confidence = st.number_input("Masukkan minimum confidence:", min_value=0.01, max_value=1.0,)
